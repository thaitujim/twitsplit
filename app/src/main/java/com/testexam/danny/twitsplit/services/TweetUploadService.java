package com.testexam.danny.twitsplit.services;
...
import com.testexam.danny.twitsplit.utility.FileUtils;
...
public class TweetUploadService extends IntentService {
    ...
    public static final String EXTRA_FAIL_CAUSE = "EXTRA_FAIL_CAUSE";
    ...
    void fail(TwitterException e) {
        sendFailureBroadcast(intent, e.getMessage());
    ...
    void sendFailureBroadcast(Intent original, String message) {
        final Intent intent = new Intent(UPLOAD_FAILURE);
        intent.putExtra(EXTRA_RETRY_INTENT, original);
        intent.putExtra(EXTRA_FAIL_CAUSE, message);
        intent.setPackage(getApplicationContext().getPackageName());
        sendBroadcast(intent);
    }
